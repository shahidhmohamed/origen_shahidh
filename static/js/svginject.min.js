!(function (o, l) {
  ...
  function T(e) {
    var t,
      ...
      c = !1;
    for (n = 0; n < a[g]; n++)
      (r = (t = a[n]).localName) in G &&
        ((c = !0),
        (f[r] = 1),
        (t.id += o),
        ["xlink:href", "href"].forEach(function (e) {
          var r = t[k](e);
          /^\s*#/.test(r) && t[h](e, r.trim() + o);
        }));
    for (r in f)
      (G[r] || [r]).forEach(function (e) {
    ...
    if (u[g]) {
      ...
      var l,
        ...
        m = e[y]("*");
      for (n = 0; n < m[g]; n++)
        if ((l = m[n]).localName == E)
          (v = (d = l.textContent) && d.replace(p, "url(#$1" + o + ")")) !==
            d && (l.textContent = v);
        else if (l.hasAttributes())
          for (i = 0; i < u[g]; i++)
            (s = u[i]),
              (v = (d = l[k](s)) && d.replace(p, "url(#$1" + o + ")")) !== d &&
                l[h](s, v);
    }
    return c;
  }
  function P(e, r, t, n) {
    if (r) {
      r[h]("data-inject-url", t);
      var i = e.parentNode;
      if (i) {
        n.copyAttributes &&
          (function c(e, r) {
            for (var t, n, i, o = e.attributes, a = 0; a < o[g]; a++)
  ...
  function p() {
    for (var e = {}, r = arguments, t = 0; t < r[g]; t++) {
      var n = r[t];
  ...
  function V(e, r) {
    if (r) {
      ...
      return t[y]("parsererror")[g] ? w : t.documentElement;
    }
  ...
  function i(e, r, t) {
    (e[x] = c), t.onFail ? t.onFail(e, r) : n(r);
  }
  function _(e, r) {
    m(e), i(e, I, r);
  }
  ...
  var e = (function R(e, r) {
    ...
    function n(a, f) {
      ...
      return typeof Promise == b ? e() : new Promise(e);
    }
    function u(u, c, e) {
      if (u) {
        var r = u[x];
        if (r) Array.isArray(r) ? r.push(e) : e();
          ...
          if ((M(u), !j)) return D(u, c), void e();
          var t = c.beforeLoad,
            n = (t && t(u)) || u[k]("src");
          if (!n) return "" === n && F(u, c), void e();
          var i = [];
          u[x] = i;
          var l = function () {
              e(),
          ...
          !(function m(e, r, t) {
            ...
            s,
            function (e, r) {
              var t = e instanceof Document ? e.documentElement : V(r, !0),
                n = c.afterLoad;
              if (n) {
                var i = n(t, r) || t;
                if (i) {
                  var o = "string" == typeof i;
                  (r = o ? i : O(t)), (t = o ? V(i, !0) : i);
                }
              }
    ...
    return (
      ...
      (n.err = function (e, r) {
        e
          ? e[x] != c &&
            (M(e), j ? (m(e), F(e, t)) : D(e, t), r && (m(e), (e.src = r)))
          : q();
      }),
      (o[e] = n)
    );
